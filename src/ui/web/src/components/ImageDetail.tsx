...
export function ImageDetail({ image, onClose, setForm, setActiveTab, allImages, onNavigate, onToggleFavorite, onEditImage, onDeleteImage }: Props) {
  ...
  }, [image, goPrev, goNext, onToggleFavorite, onDeleteImage, setForm, setActiveTab, onClose])
